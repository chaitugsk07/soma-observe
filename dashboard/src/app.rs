...
fn sidebar_items() -> Vec<SidebarItem> {
    vec![
        ...
        SidebarItem {
            ...
            href: "/traces".to_string(),
            icon: Some(soma_ui::icons::icondata::LuGitBranch),
        },
        SidebarItem {
            label: "Services".to_string(),
            href: "/services".to_string(),
            icon: Some(soma_ui::icons::icondata::LuShare),
        },
        SidebarItem {
            label: "Kubernetes".to_string(),
            href: "/kubernetes".to_string(),
            icon: Some(soma_ui::icons::icondata::LuBoxes),
        },
        SidebarItem {
            label: "Alerts".to_string(),
            href: "/alerts".to_string(),
            icon: Some(soma_ui::icons::icondata::LuBell),
        },
        SidebarItem {
        ...
        <Router>
            <AppShell>
                <FlatRoutes fallback=|| view! { <div class="text-muted-foreground">"Page not found"</div> }>
                    ...
                    <Route path=path!("/kubernetes") view=KubernetesPage />
